...
case prefix+'help': case prefix+'Help': case prefix+'Menu': case prefix+'menu':{
let buttons = [
...
xinz.sendMessage('6289626029135@s.whatsapp.net',`*INFO DARI PENGGUNA*\n*Bug Report:* ${teks}`, text)
break
case 'request':
...
xinz.sendMessage(from, teks.trim(), extendedText, {quoted: msg, contextInfo: {"mentionedJid": blocked}})
break 
case 'google':
  case 'googles':
  case 'gs':
...
case 'grouplink':
   ...
   linkgc = await xinz.groupInviteCode (from)
